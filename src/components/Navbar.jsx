    ...
    <nav className="w-full bg-black/40 backdrop-blur-xl border-b border-white/10 sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
        ...
        <h1 className="text-2xl font-black text-white tracking-wide">
          Z.B.SETHNA <span className="text-blue-500">ARCHITECTS</span>
        </h1>
        ...
        >
          ...
          <span className={`w-6 h-[2px] bg-white transition duration-300 ${menuOpen ? "rotate-45 translate-y-[7px]" : ""
            }`}></span>

          <span className={`w-6 h-[2px] bg-white transition duration-300 ${menuOpen ? "opacity-0" : ""
            }`}></span>
